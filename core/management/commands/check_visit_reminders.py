...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            action="store_true",
            dest="retry_failed",
            help="Retry failed reminder logs for the given execution date.",
        )
    ...
    def handle(self, *args, **options):
        ...
        summary = process_due_visit_reminders(
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Visit reminders processed. "
                f"Date={summary.get('processed_date')} "
